...
CPPPATH_NODE = '/home/ankur/nvm/v0.8.1/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-Wall', '-O3']
...
LIBDIR = '/home/ankur/.node_libraries'
LIBPATH_HIREDIS = '../deps/hiredis'
LIBPATH_NODE = '/home/ankur/nvm/v0.8.1/lib'
LIBPATH_ST = '-L%s'
LIB_HIREDIS = 'hiredis'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/home/ankur/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/home/ankur/nvm/v0.8.1'
